...
func (in *InstallationSpec) DeepCopyInto(out *InstallationSpec) {
	*out = *in
	...
	if in.ImportDataExecutions != nil {
		in, out := &in.ImportDataExecutions, &out.ImportDataExecutions
		*out = make([]MappingTemplateExecutor, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ExportDataExecutions != nil {
		in, out := &in.ExportDataExecutions, &out.ExportDataExecutions
		*out = make([]MappingTemplateExecutor, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MappingTemplateExecutor) DeepCopyInto(out *MappingTemplateExecutor) {
	*out = *in
	in.Template.DeepCopyInto(&out.Template)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MappingTemplateExecutor.
func (in *MappingTemplateExecutor) DeepCopy() *MappingTemplateExecutor {
	if in == nil {
		return nil
	}
	out := new(MappingTemplateExecutor)
	in.DeepCopyInto(out)
	return out
}
